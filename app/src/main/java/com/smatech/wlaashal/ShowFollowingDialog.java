...
public class ShowFollowingDialog extends AppCompatDialogFragment {
    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView)v.findViewById(R.id.title)).setText("المتابع لهم");
        ...
        close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ShowFollowingDialog.this.dismiss();
            }
        });
    ...
    private void loadData(){
        ...
        try {
            ...
            Service.getFollowing(product_id,getContext(), new RequestCallBack() {
                @Override
